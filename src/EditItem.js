...
const handleAddItem = () => {
  ...
  <h1 className="text-3xl font-bold text-white ">Update Your Lazy Susan </h1>
  ...
  {/* <div className="flex-shrink-full border-t border-gray-200 px-2 py-1 sm:px-6 lg:w-96 lg:border-r lg:border-t-0 lg:pl-8 xl:pl-6"> */}
    ...
    {/* White Background  */}
    <div className="mb-5 grid flex-cols-1 gap-5">
...
<div className="flex flex-col md: gap-5">
        ...
        className="flex w-full max-w-lg rounded-lg border border-slate-200 px-2 py-1 hover:border-gray-500 focus:outline-none focus:ring focus:ring-blue-00/40 active:ring active:ring-blue-500/40" />
      </div>
   ...
   <div className="relative">
      ...
      <p className="text-sm text-center text-gray-500">Set alert notifications for your Lazy Susan item</p>
      <div className="mt-2">
   ...
   <div className="flex flex-col">
    ...
    {/* Add item button*/}
    <div className="mb-5 grid-cols-1 gap-5 flex flex-col">
       <button
        type="submit"
        className="rounded-md bg-green-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-600" 

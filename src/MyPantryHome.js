            ...
            <div className="px-4 sm:px-6 lg:px-8">
              <div className="sm:flex sm:items-center">
                <div className="sm:flex-auto">
                  <h1 className="text-base font-semibold leading-6 text-white">My Pantry</h1>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="bg-gray-900 py-10">
            <div className="px-4 sm:px-6 lg:px-8">
              <div className="sm:flex sm:items-center">
                    <div className="sm:flex-auto">
                  <h1 className="text-base font-semibold leading-6 text-white">My Refrigerator</h1>
                  <p className="mt-2 text-sm text-gray-300">
                    A list of all items in my refrigerator including their name, quantity, unit, .
                  </p>
                </div>
                <div className="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                  <button
        ...
        <div className="mx-auto max-w-7xl">
          <div className="bg-gray-900 py-10">
            <div className="px-4 sm:px-6 lg:px-8">
              <div className="sm:flex sm:items-center">
                    <div className="sm:flex-auto">
                  <h1 className="text-base font-semibold leading-6 text-white">My Freezer</h1>
                  <p className="mt-2 text-sm text-gray-300">

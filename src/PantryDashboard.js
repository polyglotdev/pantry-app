    ...
    {/* <!-- Statistics Cards --> */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 p-4 gap-4">
          ...
          <a href='/expiringitems' className="border-none bg-gradient-to-br from-blue-200 to-gray-100 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-gray-700 dark:border-gray-600 text-gray-600 font-medium group">
            ...
            <button>
          <a href='/inventory#1' className="border-none bg-gradient-to-br from-blue-200 to-gray-100 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-green-700 dark:border-gray-600 text-gray-600 font-medium group">
            <div className="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
          ...
          <button>
          <a href='inventory#2' className="border-none bg-gradient-to-br from-blue-200 to-gray-100 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-green-700 dark:border-gray-600 text-gray-600 font-medium group">
            <div className="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
            ...
            <button>
          <a href='/inventory#3' className="border-none bg-gradient-to-br from-blue-200 to-gray-100 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-green-700 dark:border-gray-600 text-gray-600 font-medium group">
            <div className="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">

    ...
    {/* <!-- Statistics Cards --> */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 p-4 gap-4">
          ...
          <div className="border-none bg-gradient-to-br from-blue-200 to-gray-100 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-green-700 dark:border-gray-600 text-gray-600 font-medium group">
            <div className="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
              <svg width="40" height="3=40" fill="currentColor" viewBox="0 0 24 24" stroke="0" className="stroke-current text-green-800 dark:text-gray-800 transform transition-transform duration-500 ease-in-out"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth=".5" d="M19 1v2H5V1H3v22h2v-2h14v2h2V1h-2zm0 4v6h-6V7H7v4H5V5h14zm-2 14v-4h-6v4H5v-6h14v6h-2z"></path></svg>
            </div>
            <div className="text-right">
          ...
          <div className="border-none bg-gradient-to-br from-blue-200 to-gray-100 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-green-700 dark:border-gray-600 text-gray-600 font-medium group">
            <div className="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
              <svg width="45" height="45" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="stroke-current text-green-800 dark:text-gray-800 transform transition-transform duration-500 ease-in-out"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 3m0 2a2 2 0 0 1 2 -2h10a2 2 0 0 1 2 2v14a2 2 0 0 1 -2 2h-10a2 2 0 0 1 -2 -2z"></path><path d="M5 10h14"></path><path d="M9 13v3"></path><path d="M9 13v3"></path></svg>
            </div>
            <div className="text-right">
